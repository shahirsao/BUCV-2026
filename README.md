...
![spinal x-ray image](https://github.com/shahirsao/BUCV-2026/blob/main/bucv26/train_images/1080_1225.jpg)
## Overview
...
An in-depth exploratory data analysis was also performed to inform decisions made during the creation of the deep-learning models.

Some of the challenges that were faced during this task were the framing of the deep-learning task (two separately trained models for BMI regression and sex classification versus a single multimodal architecture), the cleaning of the noisy images and the selection and justification for different image models.

## Kaggle Results
My best model placed 2nd on the public leaderboard and 6th on the private leaderboard, with scores of 0.5539 and 0.5345 respectively. The evaluation scores were calculated by $AUC/1 + Normalised RMSE$ with AUC being for sex and Normalised RMSE being for BMI.
